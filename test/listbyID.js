...
describe("Open Simple List", function() {
  ...
  it("Face Mapping Trade By Id", function(done) {
  ...
  it("BioLumin-C By Id", function(done) {
  ...
  it("Rapid Reveal By Id", function(done) {
    var key = "54d8f9eb-c0fc-4dee-a55b-3abde4e0c94e";
    //console.log(subPath);
    var inputvalues = fun.input(key, subPath);
    fun.list_requester(inputvalues, done);
  })
  it("FaceMapping.com By Id", function(done) {
    var key = "5d24a390-b66e-4780-8d02-907bef2f778f";
    //console.log(subPath);
    var inputvalues = fun.input(key, subPath);
    fun.list_requester(inputvalues, done);
  })
  it("Breakout predictor By Id", function(done) {
